...
\begin{figure}%
	\centering
	\subfloat[\centering Using Contraceptives]{{\includegraphics[width=5cm]{atleast_10years_25_alpha.png} }}%
	\qquad
	\subfloat[\centering Without Using Contraceptives]{{\includegraphics[width=5cm]{innovation_atleast_10years_25_alpha.png} }}%
