...
fecundability and
fertility period and length of menstrual cycle etc. \\%Occurrence of conception even after using contraceptives.\\
...
Family planning is always something that is of vital importance to any couple. A part of our model also focuses on the effect of using contraceptives for couples. The concept of safe sex has there been for quite some time though we find couples not understaing its importance. In the project we modelled these scenarios. We got the probabilities (quantification) which safe sex brings.\\
%### HU DEAFEN PAR CHU, KAI HOI TO CALL KARJO
